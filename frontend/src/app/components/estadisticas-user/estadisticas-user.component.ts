...
@Component({
  selector: 'app-estadisticas-user',
  templateUrl: './estadisticas-user.component.html',
  styleUrls: ['./estadisticas-user.component.css']
})
export class EstadisticasUserComponent implements OnInit {
